        ...
        if has_race_data is True and json_data["weekend_race"] is not None:
            for j in json_data['weekend_race']:
                ...
                race_info_df = pd.concat(
                    [race_info_df, row_df], ignore_index=True)
                ...
                for k in j['results']:
                    ...
                    row_df['official_car_number'] = str(
                        k['official_car_number'])
                ...
                for k in j['caution_segments']:
                    ...
                    row_df['beneficiary_car_number'] = str(
                        k['beneficiary_car_number'])
...
def main():
    ...
    for i in range(current_year, current_year+1):
        ...
        weekend_runs_df.to_csv(
            f"nascar_api/weekend_runs/{i}_weekend_runs.csv", index=False)
